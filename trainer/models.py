...
class FFT2d(Layer):
    ...
    def call(self, inputs):
        ...
        reshaped=tf.cast(reshaped, dtype=tf.complex128)
        fft = tf.signal.fft2d(reshaped)
        orig_shape = tf.reshape(fft, shape=[-1, shape_data[1], shape_data[2], shape_data[3]])
        return orig_shape
...
def add_discriminator_block(old_model, n_input_layers=2):
    ...
    d_1 = Conv2D(512, (1, 2), strides=(1, 2), padding='valid', kernel_initializer='he_normal', dtype=tf.complex128)(d_1)
    d_1 = Conv2D(512, (2, 1), strides=(2, 1), padding='valid', kernel_initializer='he_normal', dtype=tf.complex128)(d_1)
    d_1 = iFFT2d()(d_1)
    d_1 = Dense(128)(d_1)
    d_1 = Dropout(0.2)(d_1)
...
def define_discriminator(n_blocks, input_shape=(4, 750, 2)):
    ...
    # convolusion block 1
    d_1 = Conv2D(32, (1, 151), padding='valid')(featured_block)
    d_1 = FFT2d()(featured_block)
    d_1 = Conv2D(32, (1, 201), padding='valid', dtype=tf.complex128)(d_1)
    d_1 = Conv2D(32, (1, 301), padding='valid', dtype=tf.complex128)(d_1)
    d_1 = iFFT2d()(d_1)
...
def define_generator(n_blocks, latent_dim):
    ...
    i_sel_0=Conv2D(32, (1,6), padding='valid', name="defly_"+counter.get_next(), dtype=tf.complex128)(i_sel_0)
    ...
    b0_r7 = SlicerLayer(index_work=6)(des_ly_0)
    b0_r7 = FFT2d()(b0_r7)
    b0_r7 = Conv2DTranspose(8, (1, 23), strides=(1,3), padding='valid', dtype=tf.complex128)(b0_r7)
    b0_r7 = Conv2DTranspose(16, (1, 81), padding='valid', dtype=tf.complex128)(b0_r7)
    b0_r7 = iFFT2d()(b0_r7)
    #rama 8 bloque 0
    b0_r8 = SlicerLayer(index_work=7)(des_ly_0)
    b0_r8 = FFT2d()(b0_r8)
    b0_r8 = Conv2DTranspose(8, (1, 51), padding='valid', dtype=tf.complex128)(b0_r8)
    b0_r8 = Conv2DTranspose(8, (1, 101), padding='valid', dtype=tf.complex128)(b0_r8)
    b0_r8 = Conv2DTranspose(16, (1, 51), padding='valid', dtype=tf.complex128)(b0_r8)
    b0_r8 = iFFT2d()(b0_r8)
    #rama 9 bloque 0
    b0_r9 = SlicerLayer(index_work=8)(des_ly_0)
    b0_r9 = FFT2d()(b0_r9)
    b0_r9 = Conv2DTranspose(16, (1, 5), strides=(1,5), padding='valid', dtype=tf.complex128)(b0_r9)
    b0_r9 = iFFT2d()(b0_r9)
    #rama 10 bloque 0
    b0_r10 = SlicerLayer(index_work=9)(des_ly_0)
    b0_r10 = FFT2d()(b0_r10)
    b0_r10 = Conv2DTranspose(8, (1, 3), strides=(1,2), padding='valid', dtype=tf.complex128)(b0_r10)
    b0_r10 = Conv2DTranspose(8, (1, 5), strides=(1,2), padding='valid', dtype=tf.complex128)(b0_r10)
    b0_r10 = Conv2DTranspose(16, (1, 46), padding='valid')(b0_r10)
    b0_r10 = iFFT2d()(b0_r10)
    #rama 11 bloque 0
    b0_r11 = SlicerLayer(index_work=10)(des_ly_0)
    b0_r11 = FFT2d()(b0_r11)
    b0_r11 = Conv2DTranspose(8, (1, 23), strides=(1,3), padding='valid', dtype=tf.complex128)(b0_r11)
    b0_r11 = Conv2DTranspose(16, (1, 81), padding='valid', dtype=tf.complex128)(b0_r11)
    b0_r11 = iFFT2d()(b0_r11)
    #rama 12 bloque 0
    b0_r12 = SlicerLayer(index_work=11)(des_ly_0)
    b0_r12 = FFT2d()(b0_r12)
    b0_r12 = Conv2DTranspose(8, (1, 51), padding='valid', dtype=tf.complex128)(b0_r12)
    b0_r12 = Conv2DTranspose(8, (1, 101), padding='valid', dtype=tf.complex128)(b0_r12)
    b0_r12 = Conv2DTranspose(16, (1, 51), padding='valid', dtype=tf.complex128)(b0_r12)
    ...
    i_sel_1=Conv2D(32, (1,16), padding='valid', name="defly_"+counter.get_next(), dtype=tf.complex128)(i_sel_1)
    ...
    b1_r7 = FFT2d()(b1_r7)
    b1_r7 = Conv2DTranspose(16, (1, 3), strides=(1,3), padding='valid', dtype=tf.complex128)(b1_r7)
    b1_r7 = iFFT2d()(b1_r7)
    #rama 8
    b1_r8 = SlicerLayer(index_work=7)(des_ly_1)
    b1_r8 = FFT2d()(b1_r8)
    b1_r8 = Conv2DTranspose(8, (1, 5), strides=(1,2), padding='valid', dtype=tf.complex128)(b1_r8)
    b1_r8 = Conv2DTranspose(16, (1, 248), padding='valid', dtype=tf.complex128)(b1_r8)
    b1_r8 = iFFT2d()(b1_r8)
    #rama 9
    b1_r9 = SlicerLayer(index_work=8)(des_ly_1)
    b1_r9 = FFT2d()(b1_r9)
    b1_r9 = Conv2DTranspose(8, (1, 36), padding='valid', dtype=tf.complex128)(b1_r9)
    b1_r9 = Conv2DTranspose(8, (1, 132), strides=(1,2), padding='valid', dtype=tf.complex128)(b1_r9)
    b1_r9 = Conv2DTranspose(16, (1, 51), padding='valid', dtype=tf.complex128)(b1_r9)
    b1_r9 = iFFT2d()(b1_r9)
    #rama 10
    b1_r10 = SlicerLayer(index_work=9)(des_ly_1)
    b1_r10 = FFT2d()(b1_r10)
    b1_r10 = Conv2DTranspose(8, (1, 101), padding='valid', dtype=tf.complex128)(b1_r10)
    b1_r10 = Conv2DTranspose(8, (1, 351), padding='valid', dtype=tf.complex128)(b1_r10)
    b1_r10 = Conv2DTranspose(16, (1, 51), padding='valid', dtype=tf.complex128)(b1_r10)
    b1_r10 = iFFT2d()(b1_r10)
    #rama 11
    b1_r11 = SlicerLayer(index_work=10)(des_ly_1)
    b1_r11 = FFT2d()(b1_r11)
    b1_r11 = Conv2DTranspose(8, (1, 16), padding='valid', dtype=tf.complex128)(b1_r11)
    b1_r11 = Conv2DTranspose(8, (1, 36), padding='valid', dtype=tf.complex128)(b1_r11)
    b1_r11 = Conv2DTranspose(8, (1, 51), padding='valid', dtype=tf.complex128)(b1_r11)
    b1_r11 = Conv2DTranspose(8, (1, 76), padding='valid', dtype=tf.complex128)(b1_r11)
    b1_r11 = Conv2DTranspose(8, (1, 101), padding='valid', dtype=tf.complex128)(b1_r11)
    b1_r11 = Conv2DTranspose(8, (1, 151), padding='valid', dtype=tf.complex128)(b1_r11)
    b1_r11 = Conv2DTranspose(16, (1, 76), padding='valid', dtype=tf.complex128)(b1_r11)
    b1_r11 = iFFT2d()(b1_r11)
    #rama 12
    b1_r12 = SlicerLayer(index_work=11)(des_ly_1)
    b1_r12 = FFT2d()(b1_r12)
    b1_r12 = Conv2DTranspose(8, (1, 16), padding='valid', dtype=tf.complex128)(b1_r12)
    b1_r12 = Conv2DTranspose(8, (1, 36), padding='valid', dtype=tf.complex128)(b1_r12)
    b1_r12 = Conv2DTranspose(8, (1, 301), padding='valid', dtype=tf.complex128)(b1_r12)
    b1_r12 = Conv2DTranspose(16, (1, 151), padding='valid', dtype=tf.complex128)(b1_r12)
    b1_r12 = iFFT2d()(b1_r12)
    #sumar ramas
    ...
    i_sel_2=Conv2D(32, (1,26), padding='valid', name="defly_"+counter.get_next(), dtype=tf.complex128)(merger_b1)
    i_sel_2=Conv2D(32, (1,26), padding='valid', name="defly_"+counter.get_next(), dtype=tf.complex128)(i_sel_2)
    ...
    b2_r7 = FFT2d()(b2_r7)
    b2_r7 = UpSampling2D(dtype=tf.complex128)(b2_r7)
    b2_r7 = UpSampling2D(size=(2,1), dtype=tf.complex128)(b2_r7)
    b2_r7 = Conv2D(8, (1, 201), padding='valid', dtype=tf.complex128)(b2_r7)
    b2_r7 = Conv2D(8, (1, 251), padding='valid', dtype=tf.complex128)(b2_r7)
    b2_r7 = Conv2D(16, (1, 301), padding='valid', dtype=tf.complex128)(b2_r7)
    b2_r7 = iFFT2d()(b2_r7)
    #rama 8
    b2_r8 = SlicerLayer(index_work=7)(des_ly_2)
    b2_r8 = FFT2d()(b2_r8)
    b2_r8 = UpSampling2D(dtype=tf.complex128)(b2_r8)
    b2_r8 = UpSampling2D(size=(2,1), dtype=tf.complex128)(b2_r8)
    b2_r8 = Conv2D(8, (1, 201), padding='valid', dtype=tf.complex128)(b2_r8)
    b2_r8 = Conv2D(8, (1, 251), padding='valid', dtype=tf.complex128)(b2_r8)
    b2_r8 = Conv2D(16, (1, 301), padding='valid', dtype=tf.complex128)(b2_r8)
    b2_r8 = iFFT2d()(b2_r8)
    #rama 9
    b2_r9 = SlicerLayer(index_work=8)(des_ly_2)
    b2_r9 = FFT2d()(b2_r9)
    b2_r9 = UpSampling2D(size=(2,1), dtype=tf.complex128)(b2_r9)
    b2_r9 = UpSampling2D(size=(2,1), dtype=tf.complex128)(b2_r9)
    b2_r9 = Conv2D(16, (4, 150), padding='same', dtype=tf.complex128)(b2_r9)
    b2_r9 = iFFT2d()(b2_r9)
    #rama 10
    b2_r10 = SlicerLayer(index_work=9)(des_ly_2)
    b2_r10 = FFT2d()(b2_r10)
    b2_r10 = UpSampling2D(size=(2,1), dtype=tf.complex128)(b2_r10)
    b2_r10 = UpSampling2D(size=(2,1), dtype=tf.complex128)(b2_r10)
    b2_r10 = Conv2D(8, (2, 150), padding='same', dtype=tf.complex128)(b2_r10)
    b2_r10 = Conv2D(16, (2, 150), padding='same', dtype=tf.complex128)(b2_r10)
    b2_r10 = iFFT2d()(b2_r10)
    #rama 11
    b2_r11 = SlicerLayer(index_work=10)(des_ly_2)
    b2_r11 = FFT2d()(b2_r11)
    b2_r11 = UpSampling2D(size=(2,1), dtype=tf.complex128)(b2_r11)
    b2_r11 = UpSampling2D(size=(2,1), dtype=tf.complex128)(b2_r11)
    b2_r11 = Conv2D(16, (4, 150), padding='same', dtype=tf.complex128)(b2_r11)
    b2_r11 = iFFT2d()(b2_r11)
    #rama 12
    b2_r12 = SlicerLayer(index_work=11)(des_ly_2)
    b2_r12 = FFT2d()(b2_r12)
    b2_r12 = UpSampling2D(size=(2,1), dtype=tf.complex128)(b2_r12)
    b2_r12 = UpSampling2D(size=(2,1), dtype=tf.complex128)(b2_r12)
    b2_r12 = Conv2D(8, (2, 150), padding='same', dtype=tf.complex128)(b2_r12)
    b2_r12 = Conv2D(16, (2, 150), padding='same', dtype=tf.complex128)(b2_r12)
    b2_r12 = iFFT2d()(b2_r12)
    #unir ramas
    ...
    i_sel_3=Conv2D(16, (1,26), padding='valid', name="defly_"+counter.get_next(), dtype=tf.complex128)(i_sel_3)
    i_sel_3=Conv2D(32, (1,26), padding='valid', name="defly_"+counter.get_next(), dtype=tf.complex128)(i_sel_3)
