...
def define_generator(n_blocks, latent_dim):
    ...
    i_sel_1_b_2=Conv2D(16, (1,87), padding='valid', name="defly_"+counter.get_next())(i_sel_1_b_2)
    #unir ramas
    ...
    on_freq=Conv2DTranspose(32, (1,51), padding="valid")(on_freq)
...
def get_saved_model(dimension=(4,750,2), bucket_name="music-gen", epoch_checkpoint=80):
    custom_layers={
