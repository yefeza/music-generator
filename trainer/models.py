...
def define_generator(n_blocks, latent_dim):
    ...
    #g_1 = Conv2DTranspose(512, (1, 241), padding='valid', kernel_initializer='he_normal')(g_1)
    #g_1 = Conv2DTranspose(512, (1, 271), padding='valid', kernel_initializer='he_normal')(g_1)
    #g_1 = Conv2D(64, (1, 150), padding='same', kernel_initializer='he_normal')(g_1)
    #g_1 = Conv2D(64, (1, 150), padding='same', kernel_initializer='he_normal')(g_1)
