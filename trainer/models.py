...
def define_generator(n_blocks, latent_dim):
    ...
    sumarized_blocks = Conv2D(16, (4,4), padding='same', kernel_initializer='he_normal')(sumarized_blocks)
    sumarized_blocks = Conv2D(8, (4,4), padding='same', kernel_initializer='he_normal')(sumarized_blocks)
