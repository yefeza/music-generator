...
def define_generator(n_blocks, latent_dim):
    ...
    featured = Conv2D(512, (1, 5), padding='same', kernel_initializer='he_normal')(ly0)
    ...
    s_1 = Conv2DTranspose(64, (1, 101), padding='valid', kernel_initializer='he_normal')(s_1)
    s_1 = Conv2DTranspose(64, (1, 251), padding='valid', kernel_initializer='he_normal')(s_1)
    s_1 = Conv2DTranspose(64, (1, 286), padding='valid', kernel_initializer='he_normal')(s_1)
    # deconvolusion segundo 2
    s_2 = Conv2D(64, (1, 251), padding='valid', kernel_initializer='he_normal')(s_1)
    s_2 = Conv2D(64, (1, 151), padding='valid', kernel_initializer='he_normal')(s_2)
    s_2 = Conv2DTranspose(64, (1, 251), padding='valid', kernel_initializer='he_normal')(s_2)
    s_2 = Conv2DTranspose(64, (1, 151), padding='valid', kernel_initializer='he_normal')(s_2)
    # deconvolusion segundo 3
    s_3 = Conv2D(64, (1, 251), padding='valid', kernel_initializer='he_normal')(s_2)
    s_3 = Conv2D(64, (1, 151), padding='valid', kernel_initializer='he_normal')(s_3)
    s_3 = Conv2DTranspose(64, (1, 251), padding='valid', kernel_initializer='he_normal')(s_3)
    s_3 = Conv2DTranspose(64, (1, 151), padding='valid', kernel_initializer='he_normal')(s_3)
    # deconvolusion segundo 4
    s_4 = Conv2D(64, (1, 251), padding='valid', kernel_initializer='he_normal')(s_3)
    s_4 = Conv2D(64, (1, 151), padding='valid', kernel_initializer='he_normal')(s_4)
    s_4 = Conv2DTranspose(64, (1, 251), padding='valid', kernel_initializer='he_normal')(s_4)
    ...
    sumarized_blocks = Conv2D(128, (4, 50), padding='same', kernel_initializer='he_normal')(sumarized_blocks)
...
def get_saved_model(dimension=(4,750,2), bucket_name="music-gen", epoch_checkpoint=50):
