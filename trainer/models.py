...
def define_generator(n_blocks, latent_dim):
    ...
    g_1 = Conv2DTranspose(256, (1, 31), padding='valid', kernel_initializer='he_normal')(g_1)
    g_1 = Conv2DTranspose(256, (1, 61), padding='valid', kernel_initializer='he_normal')(g_1)
    g_1 = Conv2DTranspose(256, (1, 121), padding='valid', kernel_initializer='he_normal')(g_1)
    g_1 = Conv2DTranspose(256, (1, 241), padding='valid', kernel_initializer='he_normal')(g_1)
    g_1 = Conv2DTranspose(256, (1, 271), padding='valid', kernel_initializer='he_normal')(g_1)
    #g_1 = Conv2D(64, (1, 150), padding='same', kernel_initializer='he_normal')(g_1)
    #g_1 = Conv2D(64, (1, 150), padding='same', kernel_initializer='he_normal')(g_1)
    #proyectar patron a los siguientes 4 segundos
    g_1 = Conv2DTranspose(256, (2, 1), padding='valid', kernel_initializer='he_normal')(g_1)
    g_1 = Conv2DTranspose(256, (3, 1), padding='valid', kernel_initializer='he_normal')(g_1)
