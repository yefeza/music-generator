...
def define_discriminator(n_blocks, input_shape=(4, 750, 2)):
    ...
    # convolusion block 1
    d_1 = Conv2D(64, (3, 3), padding='same', kernel_initializer='he_normal')(featured_block)
    d_1 = SoftRectifier()(d_1)
    d_1 = Dropout(0.2)(d_1)
    d_1 = Conv2D(64, (4, 4), padding='same', kernel_initializer='he_normal')(d_1)
    d_1 = SoftRectifier()(d_1)
    d_1 = Dropout(0.2)(d_1)
    d_1 = Conv2D(64, (3, 3), padding='same', kernel_initializer='he_normal')(d_1)
    d_1 = SoftRectifier()(d_1)
    ...
    d_2 = Dropout(0.2)(d_2)
    d_2 = Conv2D(64, (4, 4), padding='same', kernel_initializer='he_normal')(d_2)
    d_2 = SoftRectifier()(d_2)
    d_2 = Dropout(0.2)(d_2)
    d_2 = Conv2D(64, (3, 3), padding='same', kernel_initializer='he_normal')(d_2)
    d_2 = SoftRectifier()(d_2)
    ...
    d_3 = Dropout(0.2)(d_3)
    d_3 = Conv2D(64, (4, 4), padding='same', kernel_initializer='he_normal')(d_3)
    d_3 = SoftRectifier()(d_3)
    d_3 = Dropout(0.2)(d_3)
    d_3 = Conv2D(64, (3, 3), padding='same', kernel_initializer='he_normal')(d_3)
    d_3 = SoftRectifier()(d_3)
