...
def add_discriminator_block(old_model, n_input_layers=3):
    ...
    featured_layer = Conv2D(512, (1, 1), padding='same', kernel_initializer='he_normal')(in_image)
    featured_layer = SoftRectifier(start_alpha=soft_alpha)(featured_layer)
    #convolusion block 1
    d_1 = Conv2D(512, (3, 3), padding='same', kernel_initializer='he_normal')(featured_layer)
    d_1 = SoftRectifier(start_alpha=soft_alpha)(d_1)
    d_1 = Conv2D(512, (3, 3), padding='same', kernel_initializer='he_normal')(d_1)
    d_1 = SoftRectifier(start_alpha=soft_alpha)(d_1)
    d_1 = Conv2D(512, (2, 2), padding='same', kernel_initializer='he_normal')(d_1)
    d_1 = SoftRectifier(start_alpha=soft_alpha)(d_1)
    #convolusion block 2
    d_2 = Conv2D(512, (3, 3), padding='same', kernel_initializer='he_normal')(d_1)
    d_2 = SoftRectifier(start_alpha=soft_alpha)(d_2)
    d_2 = Conv2D(512, (3, 3), padding='same', kernel_initializer='he_normal')(d_2)
    d_2 = SoftRectifier(start_alpha=soft_alpha)(d_2)
    d_2 = Conv2D(512, (2, 2), padding='same', kernel_initializer='he_normal')(d_2)
    d_2 = SoftRectifier(start_alpha=soft_alpha)(d_2)
    #convolusion block 3
    d_3 = Conv2D(512, (3, 3), padding='same', kernel_initializer='he_normal')(d_2)
    d_3 = SoftRectifier(start_alpha=soft_alpha)(d_3)
    d_3 = Conv2D(512, (3, 3), padding='same', kernel_initializer='he_normal')(d_3)
    d_3 = SoftRectifier(start_alpha=soft_alpha)(d_3)
...
def define_discriminator(n_blocks, input_shape=(4, 750, 2)):
    ...
    in_image = Input(shape=input_shape)
    # conv 1x1
    featured_block = Conv2D(512, (1, 1), padding='same', kernel_initializer='he_normal')(in_image)
    featured_block = SoftRectifier()(featured_block)
    # convolusion block 1
    d_1 = Conv2D(512, (3, 3), padding='same', kernel_initializer='he_normal')(featured_block)
    d_1 = SoftRectifier()(d_1)
    d_1 = Conv2D(512, (4, 4), padding='same', kernel_initializer='he_normal')(d_1)
    d_1 = SoftRectifier()(d_1)
    d_1 = Conv2D(512, (3, 3), padding='same', kernel_initializer='he_normal')(d_1)
    d_1 = SoftRectifier()(d_1)
    # convolusion block 2
    ...
    d_2 = Conv2D(512, (4, 4), padding='same', kernel_initializer='he_normal')(d_2)
    d_2 = SoftRectifier()(d_2)
    d_2 = Conv2D(512, (3, 3), padding='same', kernel_initializer='he_normal')(d_2)
    d_2 = SoftRectifier()(d_2)
    # convolusion block 3
    ...
    d_3 = Conv2D(512, (4, 4), padding='same', kernel_initializer='he_normal')(d_3)
    d_3 = SoftRectifier()(d_3)
    d_3 = Conv2D(512, (3, 3), padding='same', kernel_initializer='he_normal')(d_3)
    d_3 = SoftRectifier()(d_3)
    #sumarize blocks
