...
def define_generator(n_blocks, latent_dim):
    ...
    b0_r1 = Conv2DTranspose(64, (101,2), padding='valid')(b0_r1)
    #rama 2 bloque 0
    b0_r2 = SlicerLayer(index_work=1)(des_ly_0)
    ...
    b0_r2 = Conv2DTranspose(64, (41,1), padding='valid')(b0_r2)
    b0_r2 = Conv2DTranspose(64, (102,2), padding='valid')(b0_r2)
    #rama 3 bloque 0
    b0_r3 = SlicerLayer(index_work=2)(des_ly_0)
    b0_r3 = Reshape((1,100,1))(b0_r3)
    b0_r3 = FreqToTime()(b0_r3)
    b0_r3 = Conv2DTranspose(64, (101,2), padding='valid')(b0_r3)
    b0_r3 = Conv2DTranspose(64, (177,3), padding='valid')(b0_r3)
    #sumar ramas bloque 0
