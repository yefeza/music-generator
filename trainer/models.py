...
def add_discriminator_block(old_model, n_input_layers=3):
    ...
    #convolusion block 1
    d_1 = Conv2D(128, (3, 3), padding='same', kernel_initializer='he_normal', activation=tf.math.sin)(featured_layer)
    #d_1 = LeakyReLU(alpha=0.2)(d_1)
    d_1 = Conv2D(128, (3, 3), padding='same', kernel_initializer='he_normal', activation=tf.math.sin)(d_1)
    #d_1 = LeakyReLU(alpha=0.2)(d_1)
    #d = AveragePooling2D()(d)
    d_1 = Conv2D(128, (2, 2), padding='same', kernel_initializer='he_normal', activation=tf.math.sin)(d_1)
    #d_1 = LeakyReLU(alpha=0.2)(d_1)
    #convolusion block 2
    d_2 = Conv2D(128, (3, 3), padding='same', kernel_initializer='he_normal', activation=tf.math.sin)(d_1)
    #d_2 = LeakyReLU(alpha=0.2)(d_2)
    d_2 = Conv2D(128, (3, 3), padding='same', kernel_initializer='he_normal', activation=tf.math.sin)(d_2)
    #d_2 = LeakyReLU(alpha=0.2)(d_2)
    d_2 = Conv2D(128, (2, 2), padding='same', kernel_initializer='he_normal', activation=tf.math.sin)(d_2)
    #d_2 = LeakyReLU(alpha=0.2)(d_2)
    #convolusion block 3
    d_3 = Conv2D(128, (3, 3), padding='same', kernel_initializer='he_normal', activation=tf.math.sin)(d_1)
    #d_3 = LeakyReLU(alpha=0.2)(d_3)
    d_3 = Conv2D(128, (3, 3), padding='same', kernel_initializer='he_normal', activation=tf.math.sin)(d_3)
    #d_3 = LeakyReLU(alpha=0.2)(d_3)
    d_3 = Conv2D(128, (2, 2), strides=(2,2), padding='valid', kernel_initializer='he_normal', activation=tf.math.sin)(d_3)
    #d_3 = LeakyReLU(alpha=0.2)(d_3)
    #sumarize blocks
    d_block=Conv2D(128, (1,1), padding='same', kernel_initializer='he_normal', activation=tf.math.sin)(d_3)
...
def define_discriminator(n_blocks, lstm_layer, input_shape=(4, 750, 2)):
    ...
    # convolusion block 1
    d_1 = Conv2D(128, (3, 3), padding='same', kernel_initializer='he_normal', activation=tf.math.sin)(featured_block)
    #d_1 = LeakyReLU(alpha=0.2)(d_1)
    d_1 = Conv2D(128, (4, 4), padding='same', kernel_initializer='he_normal', activation=tf.math.sin)(d_1)
    #d_1 = LeakyReLU(alpha=0.2)(d_1)
    d_1 = Conv2D(128, (3, 3), padding='same', kernel_initializer='he_normal', activation=tf.math.sin)(d_1)
    #d_1 = LeakyReLU(alpha=0.2)(d_1)
    # convolusion block 2
    d_2 = Conv2D(128, (3, 3), padding='same', kernel_initializer='he_normal', activation=tf.math.sin)(d_1)
    #d_2 = LeakyReLU(alpha=0.2)(d_2)
    d_2 = Conv2D(128, (4, 4), padding='same', kernel_initializer='he_normal', activation=tf.math.sin)(d_2)
    #d_2 = LeakyReLU(alpha=0.2)(d_2)
    d_2 = Conv2D(128, (3, 3), padding='same', kernel_initializer='he_normal', activation=tf.math.sin)(d_2)
    #d_2 = LeakyReLU(alpha=0.2)(d_2)
    # convolusion block 3
    d_3 = Conv2D(128, (3, 3), padding='same', kernel_initializer='he_normal', activation=tf.math.sin)(d_1)
    #d_3 = LeakyReLU(alpha=0.2)(d_3)
    d_3 = Conv2D(128, (4, 4), padding='same', kernel_initializer='he_normal', activation=tf.math.sin)(d_3)
    #d_3 = LeakyReLU(alpha=0.2)(d_3)
    d_3 = Conv2D(128, (3, 3), padding='same', kernel_initializer='he_normal', activation=tf.math.sin)(d_3)
    #d_3 = LeakyReLU(alpha=0.2)(d_3)
    #sumarize blocks
...
def add_generator_block(old_model):
    ...
    #bloque 1
    g_1 = Conv2D(64, (3, 3), padding='same', kernel_initializer='he_normal', activation=tf.math.sin)(featured)
    #g_1 = LeakyReLU(alpha=0.2)(g_1)
    g_1 = Conv2D(128, (3, 3), padding='same', kernel_initializer='he_normal', activation=tf.math.sin)(g_1)
    #g_1 = LeakyReLU(alpha=0.2)(g_1)
    g_1 = Conv2D(64, (6,6), padding='same', kernel_initializer='he_normal', activation=tf.math.sin)(g_1)
    #g_1 = LeakyReLU(alpha=0.2)(g_1)
    g_1 = Conv2D(128, (6, 6), padding='same', kernel_initializer='he_normal', activation=tf.math.sin)(g_1)
    #g_1 = LeakyReLU(alpha=0.2)(g_1)
    op_1 = Dense(50)(g_1)
    #bloque 2
    g_2 = Conv2D(64, (3, 3), padding='same', kernel_initializer='he_normal', activation=tf.math.sin)(featured)
    #g_2 = LeakyReLU(alpha=0.2)(g_2)
    g_2 = Conv2D(128, (3, 3), padding='same', kernel_initializer='he_normal', activation=tf.math.sin)(g_2)
    #g_2 = LeakyReLU(alpha=0.2)(g_2)
    g_2 = Conv2D(64, (6,6), padding='same', kernel_initializer='he_normal', activation=tf.math.sin)(g_2)
    #g_2 = LeakyReLU(alpha=0.2)(g_2)
    g_2 = Conv2D(128, (6, 6), padding='same', kernel_initializer='he_normal', activation=tf.math.sin)(g_2)
    #g_2 = LeakyReLU(alpha=0.2)(g_2)
    op_2 = Dense(50)(g_2)
    #bloque 3
    g_3 = Conv2D(64, (3, 3), padding='same', kernel_initializer='he_normal', activation=tf.math.sin)(featured)
    #g_3 = LeakyReLU(alpha=0.2)(g_3)
    g_3 = Conv2D(128, (3, 3), padding='same', kernel_initializer='he_normal', activation=tf.math.sin)(g_3)
    #g_3 = LeakyReLU(alpha=0.2)(g_3)
    g_3 = Conv2D(64, (6,6), padding='same', kernel_initializer='he_normal', activation=tf.math.sin)(g_3)
    #g_3 = LeakyReLU(alpha=0.2)(g_3)
    g_3 = Conv2D(128, (6, 6), padding='same', kernel_initializer='he_normal', activation=tf.math.sin)(g_3)
    #g_3 = LeakyReLU(alpha=0.2)(g_3)
    op_3 = Dense(50)(g_3)
    #sumarize
...
def define_generator(n_blocks, lstm_layer):
    ...
    g_1 = Conv2DTranspose(32, (2, 1), strides=(2, 1), padding='valid', kernel_initializer='he_normal', activation=tf.math.sin)(featured)
    #g_1 = LeakyReLU(alpha=0.2)(g_1)
    g_1 = Conv2DTranspose(64, (2, 1), strides=(2, 1), padding='valid', kernel_initializer='he_normal', activation=tf.math.sin)(g_1)
    #g_1 = LeakyReLU(alpha=0.2)(g_1)
    g_1 = Conv2DTranspose(128, (1, 15), strides=(1, 15), padding='valid', kernel_initializer='he_normal', activation=tf.math.sin)(g_1)
    #g_1 = LeakyReLU(alpha=0.2)(g_1)
    g_1 = Conv2D(64, (6,6), padding='same', kernel_initializer='he_normal', activation=tf.math.sin)(g_1)
    #g_1 = LeakyReLU(alpha=0.2)(g_1)
    g_1 = Conv2D(128, (6, 6), padding='same', kernel_initializer='he_normal', activation=tf.math.sin)(g_1)
    ...
    g_2 = Conv2DTranspose(32, (2, 1), strides=(2, 1), padding='valid', kernel_initializer='he_normal', activation=tf.math.sin)(featured)
    #g_2 = LeakyReLU(alpha=0.2)(g_2)
    g_2 = Conv2DTranspose(64, (2, 1), strides=(2, 1), padding='valid', kernel_initializer='he_normal', activation=tf.math.sin)(g_2)
    #g_2 = LeakyReLU(alpha=0.2)(g_2)
    g_2 = Conv2DTranspose(128, (1, 15), strides=(1, 15), padding='valid', kernel_initializer='he_normal', activation=tf.math.sin)(g_2)
    #g_2 = LeakyReLU(alpha=0.2)(g_2)
    g_2 = Conv2D(64, (6,6), padding='same', kernel_initializer='he_normal', activation=tf.math.sin)(g_2)
    #g_2 = LeakyReLU(alpha=0.2)(g_2)
    g_2 = Conv2D(128, (6, 6), padding='same', kernel_initializer='he_normal', activation=tf.math.sin)(g_2)
    ...
    g_3 = Conv2DTranspose(32, (2, 1), strides=(2, 1), padding='valid', kernel_initializer='he_normal', activation=tf.math.sin)(featured)
    #g_3 = LeakyReLU(alpha=0.2)(g_3)
    g_3 = Conv2DTranspose(64, (2, 1), strides=(2, 1), padding='valid', kernel_initializer='he_normal', activation=tf.math.sin)(g_3)
    #g_3 = LeakyReLU(alpha=0.2)(g_3)
    g_3 = Conv2DTranspose(128, (1, 15), strides=(1, 15), padding='valid', kernel_initializer='he_normal', activation=tf.math.sin)(g_3)
    #g_3 = LeakyReLU(alpha=0.2)(g_3)
    g_3 = Conv2D(64, (6,6), padding='same', kernel_initializer='he_normal', activation=tf.math.sin)(g_3)
    #g_3 = LeakyReLU(alpha=0.2)(g_3)
    g_3 = Conv2D(128, (6, 6), padding='same', kernel_initializer='he_normal', activation=tf.math.sin)(g_3)
