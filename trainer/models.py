...
def add_generator_block(old_model):
    ...
    for_sum_layer = SeparableConv2D(2, (4,150*mult), padding='same', kernel_initializer='he_normal')(sumarized_blocks)
...
def define_generator(n_blocks, latent_dim):
    ...
    sumarized_blocks = SeparableConv2D(2, (4,150), padding='same', kernel_initializer='he_normal')(sumarized_blocks)
