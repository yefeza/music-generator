...
def define_generator(n_blocks, latent_dim):
    ...
    g_1 = Conv2DTranspose(128, (1, 16), padding='valid', kernel_initializer='he_normal')(featured)
    g_1 = Conv2DTranspose(128, (1, 31), padding='valid', kernel_initializer='he_normal')(g_1)
    g_1 = Conv2DTranspose(128, (1, 61), padding='valid', kernel_initializer='he_normal')(g_1)
    g_1 = Conv2DTranspose(128, (1, 121), padding='valid', kernel_initializer='he_normal')(g_1)
    g_1 = Conv2DTranspose(128, (1, 241), padding='valid', kernel_initializer='he_normal')(g_1)
    g_1 = Conv2DTranspose(128, (1, 271), padding='valid', kernel_initializer='he_normal')(g_1)
    # deconvolusion segundo 2
    g_2 = Conv2DTranspose(128, (1, 16), padding='valid', kernel_initializer='he_normal')(featured)
    g_2 = Conv2DTranspose(128, (1, 31), padding='valid', kernel_initializer='he_normal')(g_2)
    g_2 = Conv2DTranspose(128, (1, 61), padding='valid', kernel_initializer='he_normal')(g_2)
    g_2 = Conv2DTranspose(128, (1, 121), padding='valid', kernel_initializer='he_normal')(g_2)
    g_2 = Conv2DTranspose(128, (1, 241), padding='valid', kernel_initializer='he_normal')(g_2)
    g_2 = Conv2DTranspose(128, (1, 271), padding='valid', kernel_initializer='he_normal')(g_2)
    # deconvolusion segundo 3
    g_3 = Conv2DTranspose(128, (1, 16), padding='valid', kernel_initializer='he_normal')(featured)
    g_3 = Conv2DTranspose(128, (1, 31), padding='valid', kernel_initializer='he_normal')(g_3)
    g_3 = Conv2DTranspose(128, (1, 61), padding='valid', kernel_initializer='he_normal')(g_3)
    g_3 = Conv2DTranspose(128, (1, 121), padding='valid', kernel_initializer='he_normal')(g_3)
    g_3 = Conv2DTranspose(128, (1, 241), padding='valid', kernel_initializer='he_normal')(g_3)
    g_3 = Conv2DTranspose(128, (1, 271), padding='valid', kernel_initializer='he_normal')(g_3)
    # deconvolusion segundo 4
    g_4 = Conv2DTranspose(128, (1, 16), padding='valid', kernel_initializer='he_normal')(featured)
    g_4 = Conv2DTranspose(128, (1, 31), padding='valid', kernel_initializer='he_normal')(g_4)
    g_4 = Conv2DTranspose(128, (1, 61), padding='valid', kernel_initializer='he_normal')(g_4)
    g_4 = Conv2DTranspose(128, (1, 121), padding='valid', kernel_initializer='he_normal')(g_4)
    g_4 = Conv2DTranspose(128, (1, 241), padding='valid', kernel_initializer='he_normal')(g_4)
    ...
    sumarized_blocks=Concatenate()([g_1,g_2,g_3,g_4])
